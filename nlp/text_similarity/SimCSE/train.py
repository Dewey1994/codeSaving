...
def load_eval_data(tokenizer, args, mode):
    ...
    for row in tqdm(rows):
        ...
        data1 = tokenizer(row['data'].strip(), max_length=args.max_len, truncation=True, padding='max_length',
                          return_tensors='pt')
        data2 = tokenizer(row['label'].strip(), max_length=args.max_len, truncation=True, padding='max_length',
                          return_tensors='pt')
    ...
    #         score = float(line[2])
    #         data1 = tokenizer(line[0].strip(), max_length=args.max_len, truncation=True, padding='max_length', return_tensors='pt')
    #         data2 = tokenizer(line[1].strip(), max_length=args.max_len, truncation=True, padding='max_length', return_tensors='pt')
    #
    #         feature_list.append((data1, data2, score))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--train_file", type=str, default=r"C:\Users\40169\PycharmProjects\codeSaving\nlp\data\STS-B\for_simcse\cnsd-sts-train.csv")
    parser.add_argument("--dev_file", type=str, default=r"C:\Users\40169\PycharmProjects\codeSaving\nlp\data\STS-B\for_simcse\cnsd-sts-dev.csv")
    parser.add_argument("--test_file", type=str, default=r"C:\Users\40169\PycharmProjects\codeSaving\nlp\data\STS-B\for_simcse\cnsd-sts-test.csv")
